        ...
        <?php
            ...
            if (isset($patientJournal['data']) && !empty($patientJournal['data'])) {
                ...
                foreach ($patientJournal['data'] as $journal) {
                    ...
                    echo '' . htmlspecialchars($journal['encounter_comment'] ?? 'N/A') . '</p>';
            ...
            if (isset($patientVital['data']) && !empty($patientVital['data'])) {
                echo '<div>';
                    ...
                    foreach ($patientVital['data'] as $vital) {
                        echo '<details>';
                            echo '<summary>Vitalvärden för ' . htmlspecialchars($vital['title'] ?? 'N/A') . '</summary>';                  
                            ...
                            echo '<p>';
                                ...
                                echo 'Andning: Andetag ' . htmlspecialchars($vital['respiratory_rate'] ?? 'N/A') . ' per minut.<br>';
